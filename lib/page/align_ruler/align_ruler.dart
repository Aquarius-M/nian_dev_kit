              ...
              children: <Widget>[
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('Left: ${_dotPosition.dx.toStringAsFixed(1)}', style: style),
                      const Padding(padding: EdgeInsets.only(top: 8)),
                      Text('Right: ${(_windowSize.width - _dotPosition.dx).toStringAsFixed(1)}', style: style),
                    ],
                  ),
                ),
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const Padding(padding: EdgeInsets.only(top: 8)),
                      Text('Bottom: ${(_windowSize.height - _dotPosition.dy).toStringAsFixed(1)}', style: style),
                    ],
                  ),
                ),
              ],
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Transform.scale(
                    scale: 1.3,
                    child: Switch(value: _switched, onChanged: _switchChanged, activeColor: Colors.red),
                  ),
                ),
                const Expanded(
                  child: Padding(
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(borderRadius: _radius, border: Border.all(color: Colors.black, width: 1)),
                child: Center(
                  child: Container(
          ...
          Positioned(left: 16, top: _toolBarY, child: GestureDetector(onVerticalDragUpdate: _toolBarPanUpdate, child: toolBar)),
